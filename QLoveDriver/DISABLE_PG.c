	...
	IN PVOID Nothing)
{
	...
	{
		g_KeBugCheckExAddress = (ULONG64)&KeBugCheckEx;//(ULONG64)fc_DbgkGetAdrress(L"KeBugCheckEx");
		...
		pslp_head_n_byte = HookKernelApi((PVOID)KiRetireDpcList,
		...
		g_KiRetireDpcList = (ULONG64)ori_pslp;
